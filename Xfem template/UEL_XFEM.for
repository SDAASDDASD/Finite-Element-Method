...
C                                                         C
C   Containing subroutines of calculation used for        C
C   all the elements                                      C
C                                                         C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C Yes
...
C Not used 
      ...
      IMPLICIT NONE
C     subroutine to calculate transposed matrix
C
      INTEGER NF, NC
...
c     Purpose : Calculate the number , local coordinates and weights of the Gauss points.
c		  Distinguish between triangles and quadrangles subdivision 
c     --------------------------------------
...
c       If the crack tip is the first point in the table)
        XYC0=XYC(ElemGGe(9),1,1:2)
        XYCPrev=XYC(ElemGGe(9),2,1:2)
        else
c       The crack tip is the last of the table
...
c		% === Two opposite sides intersection
      case(4)
